...
public class BabyLuYinAddActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.baby_pregnancydiray_luyin_add);
		...
		case R.id.rename:
			...
			if (isRecodePage) {
				...
				new DialogPregnancyJiShiBenReNameDialog(
						BabyLuYinAddActivity.this, listener2, "", R.layout.dialog_rename).show();
			} else {
				new DialogPregnancyJiShiBenReNameDialog(
						BabyLuYinAddActivity.this, listener2, titleTv.getText()
								.toString(), R.layout.dialog_rename).show();
			}
			break;
		case R.id.btn2:
			// 播放暂停按钮
	...
	private class SaveLuYinThread extends Thread {
		...
		public void run() {
			...
			// CopyFileFromData.getInstance().copyDatabase(BabyLuYinAddActivity.this,
			// "pregnancy_diary.db");
