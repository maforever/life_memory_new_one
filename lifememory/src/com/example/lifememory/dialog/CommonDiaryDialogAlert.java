...
public class CommonDiaryDialogAlert extends Dialog implements OnClickListener
{
	...
	public CommonDiaryDialogAlert(Context context, DialogAlertListener listener, String title)
	{
	...
	public CommonDiaryDialogAlert(Context context, DialogAlertListener listener, String title, Object param)
	{
		super(context, R.style.dialog);
		this.listener = listener;
		this.title = title;
